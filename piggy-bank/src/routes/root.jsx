...
export default function Root() {
  ...
  const [allDataShown, setAllDataShown] = useState(false);
    ...
    return (
      <>
      {/* Provide the balance throughout all components in the navbar */}
        ...
        <div>
          <nav style={{borderBottom: 'solid 1.5px green', position: 'fixed', width: '100%', backgroundColor: '#ffc4cd', fontFamily: 'Forum, cursive', fontSize: '1.5rem'}} className="nav nav-pills nav-justified navbar navbar-expand-lg navbar-dark sticky-top">
            <div className="container-fluid">
              ...
              <Link className="navbar-brand " to={'home'} style={{fontFamily: 'Architects Daughter, cursive', fontSize: '2rem', color: 'lightblue', textShadow: '1.5px 1.5px black', display: 'flex', flexDirection: 'row-reverse', alignitems: 'center' }}>
              ...
              {/* Bootstrap functionality for Navbar toggle button working, responsivetool for smaller screen size */}
